/* Copyright 2019 Daniel Paredes - daleonpz@gmail.com
 *
...
void Menu::draw() {
  ...
  for (int i = 0; i < 3; i++) {
    ...
    this->disp->setTextColor(text_color);
    this->disp->drawRect(0, i*20, 128, 20, bg_color);

    this->disp->setCursor(5, 2 + 20 * i);
